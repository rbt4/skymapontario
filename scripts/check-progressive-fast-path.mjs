...
assert.match(lab, /state\.models\.size>=2\)\{scheduleForecastRender\(\);startEnrichment\(id\);\}/, 'optional intelligence does not wait for the two-model gate');
...
console.log('✓ Forecast Lab 33.1.1 core-first fast-path contract passed');
